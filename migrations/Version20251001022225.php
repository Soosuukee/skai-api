 ...
 */
final class Version20251001022225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, provider_id INT NOT NULL, language_id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, summary VARCHAR(255) NOT NULL, is_published TINYINT(1) NOT NULL, is_featured TINYINT(1) NOT NULL, cover VARCHAR(255) DEFAULT NULL, published_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_23A0E66A53A8AA (provider_id), INDEX IDX_23A0E6682F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, profile_picture VARCHAR(255) DEFAULT NULL, joined_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', slug VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, postal_code VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, birth_date DATE DEFAULT NULL, UNIQUE INDEX UNIQ_C7440455E7927C74 (email), INDEX IDX_C7440455F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5373C9665E237E06 (name), UNIQUE INDEX UNIQ_5373C966989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE education (id INT AUTO_INCREMENT NOT NULL, provider_id INT NOT NULL, title VARCHAR(255) NOT NULL, institution_name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, started_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ended_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', institution_image VARCHAR(255) DEFAULT NULL, INDEX IDX_DB0A5ED2A53A8AA (provider_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE experience (id INT AUTO_INCREMENT NOT NULL, provider_id INT NOT NULL, title VARCHAR(255) NOT NULL, company_name VARCHAR(255) NOT NULL, first_task VARCHAR(255) NOT NULL, second_task VARCHAR(255) NOT NULL, third_task VARCHAR(255) NOT NULL, started_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ended_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', company_logo VARCHAR(255) DEFAULT NULL, INDEX IDX_590C103A53A8AA (provider_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE hard_skill (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_9EE9EE462B36786B (title), UNIQUE INDEX UNIQ_9EE9EE46989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE job (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_FBD8E0F82B36786B (title), UNIQUE INDEX UNIQ_FBD8E0F8989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE language (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D4DB71B55E237E06 (name), UNIQUE INDEX UNIQ_D4DB71B5989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE provider (id INT AUTO_INCREMENT NOT NULL, job_id INT NOT NULL, country_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, profile_picture VARCHAR(255) DEFAULT NULL, joined_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', slug VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, postal_code VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, birth_date DATE DEFAULT NULL, UNIQUE INDEX UNIQ_92C4739CE7927C74 (email), INDEX IDX_92C4739CBE04EA9 (job_id), INDEX IDX_92C4739CF92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE provider_hard_skill (provider_id INT NOT NULL, hard_skill_id INT NOT NULL, INDEX IDX_BB5FA2FEA53A8AA (provider_id), INDEX IDX_BB5FA2FEB7DB062 (hard_skill_id), PRIMARY KEY(provider_id, hard_skill_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE provider_soft_skill (provider_id INT NOT NULL, soft_skill_id INT NOT NULL, INDEX IDX_33FCA06CA53A8AA (provider_id), INDEX IDX_33FCA06C88034CA4 (soft_skill_id), PRIMARY KEY(provider_id, soft_skill_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE provider_language (provider_id INT NOT NULL, language_id INT NOT NULL, INDEX IDX_9C991F5CA53A8AA (provider_id), INDEX IDX_9C991F5C82F1BAF4 (language_id), PRIMARY KEY(provider_id, language_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, provider_id INT NOT NULL, title VARCHAR(255) NOT NULL, summary VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, min_price VARCHAR(255) NOT NULL, max_price VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, is_featured TINYINT(1) NOT NULL, cover VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_E19D9AD2A53A8AA (provider_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE soft_skill (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_164AECD42B36786B (title), UNIQUE INDEX UNIQ_164AECD4989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_389B7832B36786B (title), UNIQUE INDEX UNIQ_389B783989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE provider_hard_skill ADD CONSTRAINT FK_BB5FA2FEA53A8AA FOREIGN KEY (provider_id) REFERENCES provider (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE provider_hard_skill ADD CONSTRAINT FK_BB5FA2FEB7DB062 FOREIGN KEY (hard_skill_id) REFERENCES hard_skill (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE provider_soft_skill ADD CONSTRAINT FK_33FCA06CA53A8AA FOREIGN KEY (provider_id) REFERENCES provider (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE provider_soft_skill ADD CONSTRAINT FK_33FCA06C88034CA4 FOREIGN KEY (soft_skill_id) REFERENCES soft_skill (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE provider_language ADD CONSTRAINT FK_9C991F5CA53A8AA FOREIGN KEY (provider_id) REFERENCES provider (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE provider_language ADD CONSTRAINT FK_9C991F5C82F1BAF4 FOREIGN KEY (language_id) REFERENCES language (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE provider_hard_skill DROP FOREIGN KEY FK_BB5FA2FEA53A8AA');
        $this->addSql('ALTER TABLE provider_hard_skill DROP FOREIGN KEY FK_BB5FA2FEB7DB062');
        $this->addSql('ALTER TABLE provider_soft_skill DROP FOREIGN KEY FK_33FCA06CA53A8AA');
        $this->addSql('ALTER TABLE provider_soft_skill DROP FOREIGN KEY FK_33FCA06C88034CA4');
        $this->addSql('ALTER TABLE provider_language DROP FOREIGN KEY FK_9C991F5CA53A8AA');
        $this->addSql('ALTER TABLE provider_language DROP FOREIGN KEY FK_9C991F5C82F1BAF4');
        ...
        $this->addSql('DROP TABLE provider_hard_skill');
        $this->addSql('DROP TABLE provider_soft_skill');
        $this->addSql('DROP TABLE provider_language');
